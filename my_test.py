...
DATASETS = ["/project/1_2301/DPANet-master/YCB_Video_Dataset/data/0000"]
class Test(object):
    def __init__(self, conf, Dataset, datapath, Network):
        ...
        self.data = Dataset.YCBData(self.cfg)
...
if __name__=='__main__':
    ...
    conf.add_argument("--gpu", type=int, default=1)
    conf.add_argument("--model", type=str, default="res50_res/model-1")
    ...
    for e in DATASETS:
        ...
        t =Test(args, my_dataset, e, Segment)
